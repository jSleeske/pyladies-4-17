...
'''
Zadziała, użycie gwiazdki przed nazwą zmiennej sprawi, że część wartości
zostanie "spakowana" do listy
'''
first, *all_in_the_middle, last = a_list
...
# print(some_from_start, middle_one, some_from_end)
...
# print(first_key, other_keys, last_key)
# name ['last_name', 'age', 'sex'] occupation

'''
Zadziała, rozpakuje wartości do zmiennych
'''
name, *other_info, occupation = a_dict.values()
# print(name, other_info, occupation)
# John ['Kowalski', 45, 'male'] programmer
