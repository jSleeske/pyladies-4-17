...
'''
    ...
    możemy zmodyfikować poprzez dodanie/usuwanie/modyfikację właściwości
    lub metod.
    ...
    propozycji jest inicjalizacja właściwości w konstruktorze. Nie jest to
...
if __name__ == '__main__':
    simple = SimpleClass()
    '''
        Wygląda jak dodawanie właściwości ;)
    '''
